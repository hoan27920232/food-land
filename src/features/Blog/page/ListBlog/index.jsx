          ...
          <div id="content" className="col-sm-9">
            <div class="row category-row">
              {blogList.map((blog) => {
                return (
                  <div
                    class="col-sm-6 blog-layout product-list blog-category"
                    key={blog._id}
                  >
                      ...
                      <div class="blog-info">
                        <div class="image image-blog">
                          <Link to={`/blogs/${blog.slug}`} class="blog-img">
                            <img
                              src={blog.IDAnh.source}
                              alt={blog.TieuDe}
                              title={blog.TieuDe}
                              class="img-responsive object-cover"
                              style={{ height: "280px" }}
                            />
                          </Link>
                      ...
                      <div class="caption-blog caption blog-description">
                        <div class="caption-thumb">
                          <h4 class="blog-title">
                            <Link
                              to={`/blogs/${blog.slug}`}
                              className="limit-text-1line"
                            >
                              {blog.TieuDe}
                            </Link>
                          </h4>
                          <div class="blog-text limit-text-1line">
                            {blog.TomTat.length > 40
                              ? blog.TomTat.substring(0, 40) + "..."
                              : blog.TomTat}
                          </div>
            ...
            <div className="pro_pagination clearfix">
              <div className="col-sm-6 text-left">
                Showing 1 to {blogList.length} of {totalCount} ({total} Pages)
              </div>
