...
export const loginThunk = createAsyncThunk('/khachhangs/login', async(params, thunkAPI) => {
    const loginAuth = await login(params)
    return loginAuth
})

export const getMe = createAsyncThunk('/khachhangs/me', async(params, thunkAPI) => {
